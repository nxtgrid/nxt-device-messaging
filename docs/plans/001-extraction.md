...
**Plan number:** 001
**Created:** 2026-07-27
**Status:** Phase 0 complete; Phase 1 foundation through **5.4**; **Phase 1b Intermezzo closed
(I0–I3; I4 skipped). Unit 5.4 done (sendOne + post-send); next 5.5 incoming**
...
| **1** | Foundation: units 1–4, pre–Unit 5 SPI, Unit 5.1–5.4; then 5.5+ | Foundation through **5.4**; **next 5.5** |
...
Phase 0 is **done**. Phase 1 foundation through Unit **5.4** is **done**.
**Phase 1b is closed.** Next is **5.5** (incoming + thin ingress). Phase 4 still owns
...
- [ ] **Unit 5 — Core engine, framework-stripped.** Sliced for review; **command/ingress
      ...
      **ADR-006 / deferred:** D1+D3 done in 5.3; send-fail concurrency key in 5.4; D2 on
      remaining cleanup paths; D5 when touching stage-timeout reads.
