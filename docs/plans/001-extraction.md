...
**Plan number:** 001
**Created:** 2026-07-27
**Status:** Phase 0–3 done. Phase 4 sliced: **4.1 done**; **4.2A done**;
**next = 4.2B** (engine/lib `console.*`).
...
| **4** | Deployment + hygiene: metrics, structured logging, integration guide, CI | **In progress** — **4.2A done**; **next 4.2B** |
...
(**3.1–3.3**). **Phase 4** in progress: **4.2A done**; next **4.2B**. Phase 4 still owns ADR-005 observability
...
- [ ] **4.2 — Pino** (one logger; pretty stdout default; JSON opt-in; sinks deferred).
      ...
      - [ ] **4.2B** Engine / `lib` `console.*` → named children.
      - [ ] **4.2C** Plugin `console.*` → named children.
