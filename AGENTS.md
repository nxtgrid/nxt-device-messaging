...
Intermezzo closed (I0–I3; I4 skipped). Phase 2 Unit 7 (`calin-api-v1`) complete.
Next: Unit 8 (`nxt-sts`; then `calin-chirpstack` → `calin-api-v2`).**
...
`plugins[]` + `CALIN_API_V1_*`), `src/http/` (lean enqueue/get/cancel; thin ingress +
